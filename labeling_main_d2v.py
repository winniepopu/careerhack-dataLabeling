...
class ExampleApp(QtWidgets.QMainWindow, labeling.Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        myline_path = './my_line/' + name_list[self.cursor][:-3] + 'json'##set my_line dir 
...
############################################   
    def write_json(self):
        ...
        output_dir = './output/' + name_list[self.cursor][:-3] + 'json'##set output dir
        ...
        for line_dict in self.my_line_list:
            if line_dict['boundingBox'][0]<=center_x and \
               ...
               line_dict['boundingBox'][5]>=center_y:
                ...
                infer_test = self.d2v.infer_vector(doc_words=word_tokenize(line_dict['text']),alpha=0.025,steps=500)
